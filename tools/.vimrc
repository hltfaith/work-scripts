...
" Last Modified: 2017-03-30 12:13:32
...
autocmd BufRead,BufNewFile /data/app/nginx/*.conf set filetype=nginx
autocmd BufRead,BufNewFile /data/app/tengine/*.conf set filetype=nginx
